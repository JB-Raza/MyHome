    ...
    return (
        <section className="contact-us-section container-fluid p-0 my-5 ">
            <div className="row mx-5 h-100 m-0 d-flex flex-column flex-md-row align-items-center gap-5 justify-content-between">
                {/* col 1 */}
                <div className="col col-12 col-sm-10 col-md-6 d-flex flex-column justify-content-center text-center text-md-start gap-4 h-100">
                    ...
                    {/* stats */}
                    <div className="row gap-3 w-100 mx-auto justify-content-center p-0">
                        <span className="col col-12 col-sm-6 text-white p-0 row">
                            <h1 className="fs-1 m-0 text-white border-right-primary text-end align-self-center col-5 pe-md-2">100+</h1>
                            <h5 className="fs-6 fw-semibold m-0 py-2 ps-2 col text-start align-self-center">Happy Clients</h5>
                        </span>
                        <span className="col col-12 col-sm-6 text-white p-0 row">
                            <h1 className="fs-1 m-0 text-white border-right-primary text-end align-self-center col-5">50+</h1>
                            <h5 className="fs-6 fw-semibold m-0 py-2 ps-2 col text-start align-self-center">5-star reviews</h5>
                        </span>
                        <span className="col col-12 col-sm-6 text-white p-0 row">
                            <h1 className="fs-1 m-0 text-white border-right-primary text-end align-self-center col-5 pe-md-2">200+</h1>
                            <h5 className="fs-6 fw-semibold m-0 py-2 ps-2 col text-start align-self-center">Successful sales</h5>
                        </span>
                        <span className="col col-12 col-sm-6 text-white p-0 row">
                            <h1 className="fs-1 m-0 text-white border-right-primary text-end align-self-center col-5">10+</h1>
                            <h5 className="fs-6 fw-semibold m-0 py-2 ps-2 col text-start align-self-center">Years of experience</h5>
                        </span>
                    </div>
                </div>
                {/* col 2 -- contact form */}
